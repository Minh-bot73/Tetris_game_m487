# 1 "../ButtonAndJoystick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../ButtonAndJoystick.c" 2
...
void GPA_IRQHandler(void) {
    if (((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL))->INTSRC & (1 << 0)) {
        ...
        if (millis - lastSW1Time > 150) {
            if (!(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL))->PIN & (1 << 0))) {
                switchPressed = 1;
                lastSW1Time = millis;
            }
        }
...
void GPG_IRQHandler(void) {
    if (((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->INTSRC & (1 << 2)) { // UP
...
void GPC_IRQHandler(void) {
    ...
    if (((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->INTSRC & (1 << 10)) { // DOWN
...
void Joystick_Init(void)
{
  ...
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->PUSEL &= ~((0x3 << 4) | (0x3 << 8));
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->PUSEL |= ((0x1 << 4) | (0x1 << 8));
  ...
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->PUSEL &= ~((0x3 << 18) | (0x3 << 20));
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->PUSEL |= ((0x1 << 18) | (0x1 << 20));

    // Setup interrupts for ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)).2 and ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)).4
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->INTTYPE &= ~((1 << 2) | (1 << 4)); // Edge trigger
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->INTEN |= ((1 << 2) | (1 << 4)); // Falling edge interrupt enable
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->INTSRC |= ((1 << 2) | (1 << 4)); // Clear interrupt flags

    // Setup interrupts for ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)).9 and ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)).10
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->INTTYPE &= ~((1 << 9) | (1 << 10)); // Edge trigger
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->INTEN |= ((1 << 9) | (1 << 10)); // Falling edge interrupt enable
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->INTSRC |= ((1 << 9) | (1 << 10)); // Clear interrupt flags

    // Enable ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) ) interrupts
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[2] |= (1 << 8); // ((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)) interrupt
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0] |= (1 << 18); // ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)) interrupt
}
