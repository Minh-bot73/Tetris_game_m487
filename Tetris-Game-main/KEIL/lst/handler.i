...
void SYS_Init(void)
{
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 &= (~(0x0F<<0)); // Clear current settings for HCLKDIV
  ...
  // TM2 clock selection
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 &= ~ (0b111 << 16); // clear setting
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0b000 << 16); // Clock source from HXT
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (1 << 4); // Clock enable for Timer 2
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->AHBCLK |= (1 << 3);
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH &= ~((0xF << 4) | (0xF << 8) |
                       (0xF << 12) | (0xF << 16) |
                       (0xF << 20) | (0xF << 24) );
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH |= ((0x02 << 4) | (0x02 << 8) |
                      (0x02 << 12) | (0x02 << 16) |
                      (0x02 << 20) | (0x02 << 24));


    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH &= ~((0xF << 0) | (0xF << 4));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH |= ((0x02<<0) | (0x02<<4));


    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH &= ~((0xF << 24) | (0xF << 28));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH |= ((0x02 << 24) | (0x02 << 28));


    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL &= ~((0xF << 4) | (0xF << 0));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL |= ((0x02<<4) | (0x02<<0));


    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH &= ~((0xF << 0) | (0xF << 4) |
                       (0xF << 8) | (0xF << 12));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH |= ((0x02 << 0) | (0x02 << 4) |
                      (0x02 << 8) | (0x02 << 12));
  ...
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->DOUT |= (1 << 3); // Set ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)).3 high
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL |= ((0x02 << 16) | (0x02 << 20));
...
{
  if (((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->INTSTS & (1 << 0))
  {
   ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->INTSTS = (1 << 0); // Clear Timer 0 overflow flag
...
{
  // Set Prescale
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL &= ~(0xFF << 0); // clear current setting for Prescale
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL |= (0 << 0); // Prescale = (0+1) = 1

    // Duration = 1ms => Target Tiner Count = 11999
    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CMP = 11999;

  // Set TM2 operation mode to Periodic Mode
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL &= ~(0b11 << 27); // Clear current settings
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL |= (0b01 << 27); // Periodic Mode
  // The behavior selection in periodic mode is Enabled.
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL |= (1 << 20);
  // Enable TM0 interrup flag TIF
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL |= (1 << 29);

  // Configure Interrupt
  // Enable TM2 interrup flag TIF
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL |= (1 << 29);
  // ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) ) interrupt configuration
  ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[1] |= (1 << 2); // (34 - 32 = 2)
  // Clear Timer 2 overflow flag
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->INTSTS = (1 << 0); // Write 1 to clear TIF

  // TM2 Start Counting
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CTL |= (1 << 30);
...
void Timer1_Init(void)
{
  ...
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL |= (0 << 0); // Prescale = (0+1) = 1
    ...
    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CMP = 5999999;
  ...
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL |= (1 << 29);
    ...
    // ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) ) interrupt configuration
  ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[1] |= (1 << 1);
...
void EBI_Config(void)
{
  ...
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= ((1 << 0) // Enable ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))
         | (1 << 1) // 16-bit data bus
         | (0 << 2) // CS active low
  ...
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0 &= ~((1 << 22) | (1 << 23)); // clear the current bit
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0 |= (1 << 22) // Data Access Hold Time (tAHD) during ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) reading Disabled
...
void EADC_Config(void)
{
  ...
  ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->CTL &= ~(0b11 << 6); // clear the current bit
  ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->CTL |= (0b11 << 6); // 12-bit resolution
...
void enableTimer(){
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL))->CTL |= (1 << 30); // Set CEN bit to start Timer0
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL |= (1 << 30); // Set CEN bit to start Timer1
}
// Function to disable Timer0 and Timer1 by clearing the Counter Enable bit
void disableTimer(){
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL))->CTL &= ~(1 << 30); // Clear CEN bit to stop Timer0
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL &= ~(1 << 30); // Clear CEN bit to stop Timer1
}
