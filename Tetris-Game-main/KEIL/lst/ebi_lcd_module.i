...
void TMR3_IRQHandler(void)
{
    ...
    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL))->INTSTS |= (0x1ul << (0));
...
void Timer3_Init(void)
{
    ...
    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL))->CMP = 1200000;


    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL))->CTL = (0x1ul << (29)) | (1UL << (27));


    __NVIC_EnableIRQ(TMR3_IRQn);


    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11100UL))->CTL |= (0x1ul << (30));
